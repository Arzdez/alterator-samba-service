...
install -p -D -m644 parameter-validation.schema.json %buildroot%_datadir/alterator-samba-service/parameter-validation.schema.json
...
install -v -p -m 644 -D service.schema.json %buildroot%_alterator_datadir/schemas/service.schema.json
...
%_datadir/alterator-samba-service/parameter-validation.schema.json
